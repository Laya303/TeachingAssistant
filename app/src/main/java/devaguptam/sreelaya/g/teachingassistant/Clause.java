...
public class Clause extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url="https://firebasestorage.googleapis.com/v0/b/teaching-assistant-72a29.appspot.com/o/Intermediate%2FClauses.pdf?alt=media&token=1467fd16-8452-4fe0-9b5f-da0c58953fdb";
        new RetrievePDFbyte()
                .execute(url);
    }
    ...
    class RetrievePDFbyte extends AsyncTask<String,Void,byte[]> {
        ...
        {
            progressDialog = new ProgressDialog(Clause.this);
